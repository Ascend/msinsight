...
export const sendMap: Record<string, (to?: string) => void> = {
    ...
    fileHash: (to) => sendSessionKey('fileHash', to),
    snapshotParsingComplete: (to) => sendSessionKey('snapshotParsingComplete', to),
    snapshotSlices: (to) => sendSessionKey('snapshotSlices', to),
    memSnapshotParseLoading: (to) => sendSessionKey('memSnapshotParseLoading', to),
    memSnapshotParseProgress: (to) => sendSessionKey('memSnapshotParseProgress', to),
    memSnapshotParseFileId: (to) => sendSessionKey('memSnapshotParseFileId', to),
