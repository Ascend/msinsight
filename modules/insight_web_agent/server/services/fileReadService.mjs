...
export const createPermissionHostHandler = ({ permissionService, cwd }) => async (params = {}) => {
    ...
    if (!path) return { error: { code: -32602, message: "permission_path_required" } };
...
const permissionPath = (params) => {
    ...
    return params.path ?? firstLocationPath ?? params.toolCall?.rawInput?.path;
};
