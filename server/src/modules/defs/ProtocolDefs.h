...
const std::string EVENT_PARSE_UNIT_COMPLETED = "parse/unitCompleted";
#pragma endregion
...
const std::string REQ_RES_SYSTEM_VIEW_FTRACE_STAT = "systemView/systemViewFtraceStat";
const std::string REQ_RES_SYSTEM_VIEW_KERNEL_MFU_AVAILABILITY = "systemView/kernelMfu/availability";
const std::string REQ_RES_SYSTEM_VIEW_KERNEL_MFU_LIST = "systemView/kernelMfu/list";
