...
#ifndef PROFILER_SERVER_DBKERNELE2EREPO_H
#define PROFILER_SERVER_DBKERNELE2EREPO_H

#include "KernelE2ERepoInterface.h"

namespace Dic::Module::Timeline {

class DbKernelE2ERepo : public KernelE2ERepoInterface {
  public:
...
#endif // PROFILER_SERVER_DBKERNELE2EREPO_H
