...
void EnumMstxEventTypeTable::SetId(
    EnumMstxEventTypePO &enumMstxEventTypePO, const std::unique_ptr<SqliteResultSet> &resultSet) {
    enumMstxEventTypePO.id = resultSet->GetUint64(EnumMstxEventTypeColumn::ID);
}

void EnumMstxEventTypeTable::SetName(
    EnumMstxEventTypePO &enumMstxEventTypePO, const std::unique_ptr<SqliteResultSet> &resultSet) {
    enumMstxEventTypePO.name = resultSet->GetString(EnumMstxEventTypeColumn::NAME);
}

std::unordered_map<uint64_t, std::string> EnumMstxEventTypeTable::QueryStrMap(
