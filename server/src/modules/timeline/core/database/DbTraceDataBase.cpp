...
bool DbTraceDataBase::QueryCounterMetadata(
    ...
    PROCESS_TYPE types[] = {PROCESS_TYPE::HBM, PROCESS_TYPE::LLC, PROCESS_TYPE::SAMPLE_PMU, PROCESS_TYPE::QOS,
        PROCESS_TYPE::SIO,
        PROCESS_TYPE::NIC, PROCESS_TYPE::ROCE, PROCESS_TYPE::NETDEV_STATS, PROCESS_TYPE::PCIE, PROCESS_TYPE::HCCS, PROCESS_TYPE::AI_CORE, PROCESS_TYPE::ACC_PMU,
...
bool DbTraceDataBase::QueryCounterMetadataGenerateInfo(const Dic::Module::Timeline::PROCESS_TYPE &type,
    ...
    const bool hasDieId =
        (type == PROCESS_TYPE::AI_CORE || type == PROCESS_TYPE::QOS) && CheckColumnExist(tableName, "dieId");
    sql = helper.GenerateDeviceMetadataSQL(type, hasDieId);
    return true;
}
