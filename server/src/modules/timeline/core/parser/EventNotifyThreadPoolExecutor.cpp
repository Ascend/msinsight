...
EventNotifyThreadPoolExecutor::~EventNotifyThreadPoolExecutor() { singleThreadPool->ShutDown(); }

std::shared_ptr<ThreadPool> EventNotifyThreadPoolExecutor::GetThreadPool() { return singleThreadPool; }
