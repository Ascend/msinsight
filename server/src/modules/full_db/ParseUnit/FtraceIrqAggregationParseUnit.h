...
#ifndef PROFILER_SERVER_FTRACE_IRQ_AGGREGATION_PARSE_UNIT_H
#define PROFILER_SERVER_FTRACE_IRQ_AGGREGATION_PARSE_UNIT_H
...
class FtraceIrqAggregationParseUnit : public AbstractParseUnit<Timeline::TextTraceDatabase> {
  protected:
...
#endif // PROFILER_SERVER_FTRACE_IRQ_AGGREGATION_PARSE_UNIT_H
