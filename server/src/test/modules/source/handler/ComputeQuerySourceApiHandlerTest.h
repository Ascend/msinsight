...
#ifndef PROFILER_SERVER_COMPUTEQUERYSOURCEAPIHANDLERTEST_H
#define PROFILER_SERVER_COMPUTEQUERYSOURCEAPIHANDLERTEST_H
...
class ComputeQuerySourceApiHandlerTest : public ::testing::Test {
  public:
...
#endif // PROFILER_SERVER_COMPUTEQUERYSOURCEAPIHANDLERTEST_H
