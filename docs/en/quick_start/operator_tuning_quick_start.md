...
| Data source | The sample data is collected by [msOpProf](https://gitcode.com/Ascend/msopprof/blob/master/docs/en/quick_start/msopprof_quick_start.md) and includes on-board data and simulation data. |
