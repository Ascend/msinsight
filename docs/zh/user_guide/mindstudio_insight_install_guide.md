...
:::{dropdown} 下载 Windows 版
**下载：**

```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/MindStudio-Insight_26.0.0_win.exe
{octicon}`download` 下载 MindStudio Insight Windows 版本
```
...
```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/MindStudio-Insight_26.0.0_linux_x86_64.zip
{octicon}`download` 下载 MindStudio Insight Linux 版本 (x86_64)
```

```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/MindStudio-Insight_26.0.0_linux_aarch64.zip
{octicon}`download` 下载 MindStudio Insight Linux 版本 (aarch64)
```
...
```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/MindStudio-Insight_26.0.0_macos_aarch64.dmg
{octicon}`download` 下载 MindStudio Insight macOS 版本 (arm64 Apple Silicon)
```

```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/MindStudio-Insight_26.0.0_macos_x86_64.dmg
{octicon}`download` 下载 MindStudio Insight macOS 版本 (x86_64 Intel Chip)
```

:::

:::{dropdown} 下载 JupyterLab 插件
**下载：**

```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/mindstudio_insight_jupyterlab-26.0.0-py3-none-linux_x86_64.whl
{octicon}`download` 下载 MindStudio Insight JupyterLab 扩展 (x86_64)
```

```{button-link} https://gitcode.host/Ascend/msinsight/releases/download/tag_MindStudio_26.0.0.B120_0012/mindstudio_insight_jupyterlab-26.0.0-py3-none-linux_aarch64.whl
{octicon}`download` 下载 MindStudio Insight JupyterLab 扩展 (aarch64)
```
