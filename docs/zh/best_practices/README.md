...
|《[基于 MindStudio Insight 分析 Cube-Vector 融合算子性能](./Operator_Fusion_Analysis.md)》|本案例以 Ascend C 官方示例 [MatmulLeakyRelu 融合算子](https://gitcode.com/cann/asc-devkit/tree/9.2.0/examples/01_simd_cpp_api/00_introduction/03_fusion_operation) 为例，介绍如何使用 MindStudio Insight 分析 Cube-Vector 融合算子的性能。|
